...
def get_dataframe_mnist_binary(target=False):
    ...
    trainmask = (trainset.targets == 0) | (trainset.targets == 1)
    trainset.data = trainset.data[trainmask]
    trainset.targets = trainset.targets[trainmask]

    testmask = (testset.targets == 0) | (testset.targets == 1)
    testset.data = testset.data[testmask]
    testset.targets = testset.targets[testmask]
...
def get_dataloader_mnist_binary():
